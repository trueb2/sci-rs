...
| argrelextrema | scipy.signal | function | required_now | peak | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.argrelextrema.html | _peak_finding.py:L198 | argrelextrema compatibility shim | sci-rs/src/signal/peak.rs |  |  |  |  | 1D comparator-based extrema detection implemented |
| argrelmax | scipy.signal | function | required_now | peak | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.argrelmax.html | _peak_finding.py:L141 | argrelmax compatibility shim | sci-rs/src/signal/peak.rs |  |  |  |  | 1D wrapper over argrelextrema implemented |
| argrelmin | scipy.signal | function | required_now | peak | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.argrelmin.html | _peak_finding.py:L83 | argrelmin compatibility shim | sci-rs/src/signal/peak.rs |  |  |  |  | 1D wrapper over argrelextrema implemented |
...
| coherence | scipy.signal | function | required_now | spectral | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.coherence.html | _spectral_py.py:L1551 | coherence compatibility shim | sci-rs/src/signal/spectral.rs |  |  |  |  | magnitude-squared coherence implementation added |
...
| csd | scipy.signal | function | required_now | spectral | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.csd.html | _spectral_py.py:L470 | csd compatibility shim | sci-rs/src/signal/spectral.rs |  |  |  |  | cross spectral density estimation implemented |
...
| cwt | scipy.signal | function | required_now | wavelets | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.cwt.html | _wavelets.py:L459 | cwt compatibility shim | sci-rs/src/signal/peak.rs |  |  |  |  | Ricker-based continuous wavelet transform implemented |
...
| decimate | scipy.signal | function | required_now | multirate | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.decimate.html | _signaltools.py:L4497 | decimate compatibility shim | sci-rs/src/signal/multirate.rs |  |  |  |  | integer downsampling wrapper implemented |
...
| freqz | scipy.signal | function | required_now | filter_design | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.freqz.html | _filter_design.py:L274 | freqz compatibility shim | sci-rs/src/signal/spectral.rs |  |  |  |  | digital frequency response evaluation implemented |
...
| istft | scipy.signal | function | required_now | spectral | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.istft.html | _spectral_py.py:L1249 | istft compatibility shim | sci-rs/src/signal/spectral.rs |  |  |  |  | overlap-add inverse STFT implementation added |
...
| resample_poly | scipy.signal | function | required_now | multirate | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.resample_poly.html | _signaltools.py:L3224 | resample_poly compatibility shim | sci-rs/src/signal/multirate.rs |  |  |  |  | rational resampling path implemented |
...
| sosfreqz | scipy.signal | function | required_now | filter_design | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.sosfreqz.html | _filter_design.py:L739 | sosfreqz compatibility shim | sci-rs/src/signal/spectral.rs |  |  |  |  | SOS cascade frequency response implementation added |
| spectrogram | scipy.signal | function | required_now | spectral | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.spectrogram.html | _spectral_py.py:L626 | spectrogram compatibility shim | sci-rs/src/signal/spectral.rs |  |  |  |  | spectrogram via STFT magnitude squared implemented |
...
| stft | scipy.signal | function | required_now | spectral | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.stft.html | _spectral_py.py:L1058 | stft compatibility shim | sci-rs/src/signal/spectral.rs |  |  |  |  | Hann-window STFT implementation added |
...
| upfirdn | scipy.signal | function | required_now | multirate | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.upfirdn.html | _upfirdn.py:L107 | upfirdn compatibility shim | sci-rs/src/signal/multirate.rs |  |  |  |  | upsample-FIR-downsample pipeline implemented |
...
| welch | scipy.signal | function | required_now | spectral | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.welch.html | _spectral_py.py:L300 | welch compatibility shim | sci-rs/src/signal/spectral.rs |  |  |  |  | Welch PSD estimation implemented |
