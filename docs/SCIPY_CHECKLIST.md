...
| --- | --- | --- | --- | --- |
| find_peaks | peak | impl | _peak_finding.py:L729 | 1D local-maxima path with height/distance filtering |
| peak_prominences | peak | impl | _peak_finding.py:L323 | 1D prominence/base estimation implemented |
| peak_widths | peak | impl | _peak_finding.py:L467 | 1D width-at-relative-height implementation added |
| argrelextrema | peak | impl | _peak_finding.py:L198 | 1D comparator-based extrema detection implemented |
| argrelmax | peak | impl | _peak_finding.py:L141 | 1D wrapper over argrelextrema implemented |
| argrelmin | peak | impl | _peak_finding.py:L83 | 1D wrapper over argrelextrema implemented |
| find_peaks_cwt | peak | impl | _peak_finding.py:L1201 | wavelet-enhanced peak scoring path implemented |
| cwt | wavelets | impl | _wavelets.py:L459 | Ricker-based continuous wavelet transform implemented |
| upfirdn | multirate | impl | _upfirdn.py:L107 | upsample-FIR-downsample pipeline implemented |
| resample_poly | multirate | impl | _signaltools.py:L3224 | rational resampling path implemented |
| decimate | multirate | impl | _signaltools.py:L4497 | integer downsampling wrapper implemented |
| periodogram | spectral | impl | _spectral_py.py:L156 | one-sided PSD estimate implemented |
| welch | spectral | impl | _spectral_py.py:L300 | Welch PSD estimation implemented |
| csd | spectral | impl | _spectral_py.py:L470 | cross spectral density estimation implemented |
| coherence | spectral | impl | _spectral_py.py:L1551 | magnitude-squared coherence implementation added |
| stft | spectral | impl | _spectral_py.py:L1058 | Hann-window STFT implementation added |
| istft | spectral | impl | _spectral_py.py:L1249 | overlap-add inverse STFT implementation added |
| spectrogram | spectral | impl | _spectral_py.py:L626 | spectrogram via STFT magnitude squared implemented |
| freqz | filter_design | impl | _filter_design.py:L274 | digital frequency response evaluation implemented |
| sosfreqz | filter_design | impl | _filter_design.py:L739 | SOS cascade frequency response implementation added |
...
| argrelextrema | scipy.signal | function | required_now | peak | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.argrelextrema.html | _peak_finding.py:L198 | argrelextrema trait-first checked entrypoint | sci-rs/src/signal/peak.rs | argrelextrema_order1_gt_f64 |  |  |  | 1D comparator-based extrema detection implemented |
| argrelmax | scipy.signal | function | required_now | peak | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.argrelmax.html | _peak_finding.py:L141 | argrelmax trait-first checked entrypoint | sci-rs/src/signal/peak.rs | argrelmax_order1_f64 |  |  |  | 1D wrapper over argrelextrema implemented |
| argrelmin | scipy.signal | function | required_now | peak | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.argrelmin.html | _peak_finding.py:L83 | argrelmin trait-first checked entrypoint | sci-rs/src/signal/peak.rs | argrelmin_order1_f64 |  |  |  | 1D wrapper over argrelextrema implemented |
...
| coherence | scipy.signal | function | required_now | spectral | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.coherence.html | _spectral_py.py:L1551 | coherence trait-first checked entrypoint | sci-rs/src/signal/spectral.rs | coherence_f64 |  |  |  | magnitude-squared coherence implementation added |
...
| csd | scipy.signal | function | required_now | spectral | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.csd.html | _spectral_py.py:L470 | csd trait-first checked entrypoint | sci-rs/src/signal/spectral.rs | csd_f64 |  |  |  | cross spectral density estimation implemented |
...
| cwt | scipy.signal | function | required_now | wavelets | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.cwt.html | _wavelets.py:L459 | cwt trait-first checked entrypoint | sci-rs/src/signal/peak.rs | cwt_ricker_f64 |  |  |  | Ricker-based continuous wavelet transform implemented |
...
| decimate | scipy.signal | function | required_now | multirate | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.decimate.html | _signaltools.py:L4497 | decimate trait-first checked entrypoint | sci-rs/src/signal/multirate.rs | decimate_q3_f64 |  |  |  | integer downsampling wrapper implemented |
...
| find_peaks | scipy.signal | function | required_now | peak | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.find_peaks.html | _peak_finding.py:L729 | find_peaks trait-first checked entrypoint | sci-rs/src/signal/peak.rs | find_peaks_height_distance_f64 |  |  |  | 1D local-maxima path with height/distance filtering |
| find_peaks_cwt | scipy.signal | function | required_now | peak | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.find_peaks_cwt.html | _peak_finding.py:L1201 | find_peaks_cwt trait-first checked entrypoint | sci-rs/src/signal/peak.rs | find_peaks_cwt_f64 |  |  |  | wavelet-enhanced peak scoring path implemented |
...
| freqz | scipy.signal | function | required_now | filter_design | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.freqz.html | _filter_design.py:L274 | freqz trait-first checked entrypoint | sci-rs/src/signal/spectral.rs | freqz_f64 |  |  |  | digital frequency response evaluation implemented |
...
| gausspulse | scipy.signal | function | required_now | waveforms | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.gausspulse.html | _waveforms.py:L163 | GaussPulseWave1D<T>/GaussPulseConfig<T>/GaussPulseKernel<T> | sci-rs/src/signal/wave/mod.rs;sci-rs/src/signal/wave/kernels.rs | gausspulse_f64 |  |  |  | implemented in-phase output plus quadrature/envelope options and cutoff helper |
...
| istft | scipy.signal | function | required_now | spectral | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.istft.html | _spectral_py.py:L1249 | istft trait-first checked entrypoint | sci-rs/src/signal/spectral.rs | istft_f64 |  |  |  | overlap-add inverse STFT implementation added |
...
| peak_prominences | scipy.signal | function | required_now | peak | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.peak_prominences.html | _peak_finding.py:L323 | peak_prominences trait-first checked entrypoint | sci-rs/src/signal/peak.rs | peak_prominences_f64 |  |  |  | 1D prominence/base estimation implemented |
| peak_widths | scipy.signal | function | required_now | peak | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.peak_widths.html | _peak_finding.py:L467 | peak_widths trait-first checked entrypoint | sci-rs/src/signal/peak.rs | peak_widths_rel_height_f64 |  |  |  | 1D width-at-relative-height implementation added |
| periodogram | scipy.signal | function | required_now | spectral | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.periodogram.html | _spectral_py.py:L156 | periodogram trait-first checked entrypoint | sci-rs/src/signal/spectral.rs | periodogram_f64 |  |  |  | one-sided PSD estimate implemented |
...
| resample_poly | scipy.signal | function | required_now | multirate | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.resample_poly.html | _signaltools.py:L3224 | resample_poly trait-first checked entrypoint | sci-rs/src/signal/multirate.rs | resample_poly_f64 |  |  |  | rational resampling path implemented |
...
| sosfreqz | scipy.signal | function | required_now | filter_design | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.sosfreqz.html | _filter_design.py:L739 | sosfreqz trait-first checked entrypoint | sci-rs/src/signal/spectral.rs | sosfreqz_f64 |  |  |  | SOS cascade frequency response implementation added |
| spectrogram | scipy.signal | function | required_now | spectral | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.spectrogram.html | _spectral_py.py:L626 | spectrogram trait-first checked entrypoint | sci-rs/src/signal/spectral.rs | spectrogram_f64 |  |  |  | spectrogram via STFT magnitude squared implemented |
...
| stft | scipy.signal | function | required_now | spectral | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.stft.html | _spectral_py.py:L1058 | stft trait-first checked entrypoint | sci-rs/src/signal/spectral.rs | stft_f64 |  |  |  | Hann-window STFT implementation added |
| sweep_poly | scipy.signal | function | required_now | waveforms | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.sweep_poly.html | _waveforms.py:L475 | SweepPolyWave1D<T>/SweepPolyConfig<'a,T>/SweepPolyKernel<'a,T> | sci-rs/src/signal/wave/mod.rs;sci-rs/src/signal/wave/kernels.rs | sweep_poly_f64 |  |  |  | polynomial-coefficient frequency sweep implemented |
...
| unit_impulse | scipy.signal | function | required_now | waveforms | impl | codex | codex/refactor-scipy-waveforms-batch1 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.unit_impulse.html | _waveforms.py:L586 | UnitImpulse1D<T>/UnitImpulseConfig/UnitImpulseKernel | sci-rs/src/signal/wave/mod.rs;sci-rs/src/signal/wave/kernels.rs | unit_impulse_1d_f64 |  |  |  | 1D API implemented (`len`, optional `idx`) |
| upfirdn | scipy.signal | function | required_now | multirate | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.upfirdn.html | _upfirdn.py:L107 | upfirdn trait-first checked entrypoint | sci-rs/src/signal/multirate.rs | upfirdn_f64 |  |  |  | upsample-FIR-downsample pipeline implemented |
...
| welch | scipy.signal | function | required_now | spectral | impl | codex | codex/refactor-scipy-waveforms-batch2 | https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.welch.html | _spectral_py.py:L300 | welch trait-first checked entrypoint | sci-rs/src/signal/spectral.rs | welch_f64 |  |  |  | Welch PSD estimation implemented |
